...
The repo also ships a human-browsable HTML document that renders this practice visually, in detail, for fast human reading. It is derived from the docs and the implementation and is wrong wherever it disagrees with them.
